            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                <p className="text-gray-600 mb-6">
                  To get started, we need to connect your Strapi CMS. Strapi will handle your product content and related data, while this frontend manages the shopping experience.
