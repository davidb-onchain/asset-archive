...
export function ProductsPageClient({ initialProducts }: { initialProducts: StrapiProduct[] }) {
  ...
  if (isStrapiConfigured && !clientLoading && clientProducts.length === 0) {
    return (
      <div className="min-h-screen bg-white py-8">
        <div className="container mx-auto px-4">
          <div className="text-center py-20">
            ...
            <p className="text-red-500 text-sm mb-4 break-words max-w-lg mx-auto">
              {clientError || "No products found. Please ensure your Strapi configuration is correct."}
            </p>
  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            {isStrapiConfigured
              ...
              : "Sample products - connect your CMS to see real products"}
          </p>
          {!isStrapiConfigured && (
        ...
        {/* Products Grid */}
        {(!isStrapiConfigured || clientLoading) ? (
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        ...
                        <div className="mt-auto">
                          <Button
                            ...
                            disabled={addingProducts.has(String(product.id))}
                          >
                            {addingProducts.has(String(product.id)) ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : "Add to Cart"}
                          </Button>
                        </div>
                      </div>
                    </CardContent>
