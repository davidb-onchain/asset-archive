...
import { useProduct } from "@/hooks/use-strapi"
...
export function ProductPageClient({ productHandle }: ProductPageClientProps) {
  ...
  if (error || !product) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-black mb-4">Asset Not Found</h1>
          <p className="text-gray-600 mb-6">This asset doesn't exist in your library</p>
          <Link href="/">
          ...
          <div className="space-y-4">
            <div className="aspect-square bg-gray-50 rounded-lg overflow-hidden border border-gray-200">
              <img
                ...
                alt={images[selectedImage]?.alternativeText || product.title}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="prose max-w-none mb-6">
                <p className="text-gray-600 text-lg leading-relaxed">
                  {product.description || "No description available for this asset."}
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleAddToCart} className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-500">{product.availableForSale ?? true ? "In stock" : "Out of stock"}</span>
              </div>

              <div className="flex gap-4">
                <Button
                  type="submit"
                  disabled={!(product.availableForSale ?? true) || isAddingToCart}
                ...
                >
                  ...
                  {(product.availableForSale ?? true) ? "Favorite" : "Out of Stock"}
                </Button>
              </div>
            </form>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    <span className="font-medium text-black">Asset ID:</span>
                    <span className="text-gray-600">{String(product.id)}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-200">
