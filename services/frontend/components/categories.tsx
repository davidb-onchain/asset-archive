...
export function Categories() {
  ...
  const categoriesToShow = isStrapiConfigured && !loading ? categories.slice(0, 8) : []
  const showSkeleton = !isStrapiConfigured || loading || (isStrapiConfigured && !loading && categories.length === 0)
