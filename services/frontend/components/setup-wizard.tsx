...
import { CheckCircle, ExternalLink, Store, Star, ArrowRight } from "lucide-react"
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                <p className="text-gray-600 mb-6">
                  To get started, we need to connect your Strapi CMS. Strapi will handle your asset content and related data, while this frontend manages the shopping experience.
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-black">Favorites Preference</h3>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <ol className="text-sm text-gray-600 space-y-2">
                  <li>
                    1. <strong>Add Assets:</strong> Go to your Shopify admin and add some assets
                  </li>
                  <li>
                  ...
                  <li>
                    3. <strong>Restart:</strong> Restart your development server to see your assets
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Favorites Mode:</span>
                    <Badge variant="secondary" className="bg-gray-100 text-black">
                        {wantsCart ? "Favorites" : "Direct Checkout"}
                    </Badge>
                  </div>
                </div>
              </div>
